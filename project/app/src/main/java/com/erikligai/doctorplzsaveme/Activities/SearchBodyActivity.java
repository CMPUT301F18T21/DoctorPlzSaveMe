...
import com.erikligai.doctorplzsaveme.Adapters.RecordBodyAdapter;
...
public class SearchBodyActivity extends AppCompatActivity {
...
//        Log.d(TAG, "initRecyclerView: init");
        ...
        RecyclerView recyclerView = findViewById(R.id.patient_records_recycler_view_body);
        ...
        if (recordList.isEmpty()) {
            ...
            adapter = new RecordBodyAdapter(recordList, problemID);
            recyclerView.setAdapter(adapter);
            recyclerView.setLayoutManager(new LinearLayoutManager(this));

            adapter.setOnEntryClickListener(new RecordBodyAdapter.OnEntryClickListener() {
                @Override
