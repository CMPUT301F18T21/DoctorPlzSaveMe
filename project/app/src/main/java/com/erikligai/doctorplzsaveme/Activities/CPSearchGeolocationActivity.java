...
public class CPSearchGeolocationActivity extends FragmentActivity implements GoogleMap.OnMarkerClickListener, OnMapReadyCallback {
    ...
    setContentView(R.layout.activity_cpsearch_geolocation);
    ...
    if (location != null || !location.equals("")) {
        ...
        try {
            ...
            int i,j;
            ArrayList<Problem> problems = Backend.getInstance().GetCPPatientProblems(intent.getStringExtra("patientID"));
